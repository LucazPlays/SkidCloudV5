...
public abstract class Packet {
    ...
    public void write(DataContainer dataContainer) {
        dataContainer.add(getId());
        write0(dataContainer);
    }

    protected abstract void write0(DataContainer dataContainer);

    public static void read(DataContainer dataContainer) {
        final int id = dataContainer.read();
        final Packet packet = fromId(id);
        packet.read0(dataContainer);
    }

    protected abstract void read0(DataContainer dataContainer);
